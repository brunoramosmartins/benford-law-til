...
gh label create "phase:1" --color "1D76DB" --description "Phase 1 — History & Empirical Observation" --repo "$REPO" --force
gh label create "phase:2" --color "5319E7" --description "Phase 2 — Log-Uniform Derivation" --repo "$REPO" --force
gh label create "phase:3" --color "D93F0B" --description "Phase 3 — Scale Invariance" --repo "$REPO" --force
gh label create "phase:4" --color "FBCA04" --description "Phase 4 — Conformity Tests" --repo "$REPO" --force
gh label create "phase:5" --color "B60205" --description "Phase 5 — Implementation & Fraud Demo" --repo "$REPO" --force
gh label create "phase:6" --color "0E8A16" --description "Phase 6 — TIL Writing" --repo "$REPO" --force
gh label create "phase:7" --color "5319E7" --description "Phase 7 — Review & Publish" --repo "$REPO" --force
